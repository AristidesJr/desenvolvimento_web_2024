...
<body>
    <div class="div_grid">
        <fieldset>
            <legend>Cálculo Valor Parcela Composta</legend>
            
            <form action="atividade_9.php" method="post">

                <div class="div_calculo_parcela_composta">

                    <div class="div_juros_composto">
...
if(isset($_POST['valor_vista']) && isset($_POST['numero_parcela']) ) {
    ...
    $sHtml .= '     <p>Em ' . $iQuantidadeParcela . ' parcelas o valor de cada parcela será: ' . calculaValorParcelasJurosComposto($iQuantidadeParcela, $iValorVista) . 'R$</p>';
    $sHtml .= '</fieldset>';
